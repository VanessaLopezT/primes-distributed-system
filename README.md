...
* primes-new → [http://localhost:30000/docs](http://localhost:30000/docs)
* primes-status → [http://localhost:30001/docs](http://localhost:30001/docs)
* primes-result → [http://localhost:30002/docs](http://localhost:30002/docs)
